...
public class WebDriverFactory {
	...
	public static WindowsDriver<WindowsElement> getWindowsDriver(String strDestopAppPath, String strRemoteHostIP) {
		...
		try {
			return new WindowsDriver<WindowsElement>(new URL("http://"+strRemoteHostIP+":4723/wd/hub"), capabilities);			
		} catch (MalformedURLException e) {
	...
	public static AppiumDriver<WebElement> getMac2Driver(String strDestopAppPath, String strRemoteHostIP) {
		DesiredCapabilities capabilities = new DesiredCapabilities();
		capabilities.setCapability("platformName", "mac");
		capabilities.setCapability("automationName", "mac2");
		capabilities.setCapability("appium:bundleId", strDestopAppPath);
		try{
			return new AppiumDriver<WebElement>(new URL("http://"+strRemoteHostIP+":4723/wd/hub"), capabilities);			
		}
		catch (Exception e) {
